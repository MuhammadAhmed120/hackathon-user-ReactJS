...
const ThemeProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        if (theme) {
            ...
            document.body.style.background = 'linear-gradient(to bottom right, #fafafa 10%, #f5f5f5 90%)';
            ...
            document.body.style.background = 'linear-gradient(to bottom right, #191919 10%, #232323 90%)';
